...
try {
  ...
  const consumer = `
const subpaths = [
  'api-keys','cookies','cors','crypto','csrf','env','fetch','filesystem','headers','logging','presets','rate-limit','scanner','web','webhooks',
...
`;
  ...
  const typeConsumer = `
import { secureToken, safeFetch } from '@axiomnode-lab/guard';
